...
The `api-bridge-agnt` maintainers take all security issues in the project
seriously. Thank you for improving the security of `api-bridge-agnt`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`api-bridge-agnt` leverages GitHub's private vulnerability reporting.
